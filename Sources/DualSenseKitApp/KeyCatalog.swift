...
enum KeyCatalog {
    ...
    static let options: [KeyOption] = [
        // Modifier keys (hold-friendly — stay down until button released)
        KeyOption(title: "Command ⌘",  keyCode: 55),
        KeyOption(title: "Option ⌥",   keyCode: 58),
        KeyOption(title: "Control ⌃",  keyCode: 59),
        KeyOption(title: "Shift ⇧",    keyCode: 56),
        KeyOption(title: "Function Fn", keyCode: 63),
        // Navigation
